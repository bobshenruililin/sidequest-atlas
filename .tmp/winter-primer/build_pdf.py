...
MD = ROOT / "docs" / "winter-2026-27-primer.md"
...
@page {
  ...
  @bottom-center {
    content: "Winter 2026/27 Primer  ·  " counter(page);
    font-family: "Avenir Next", "Segoe UI", Helvetica, sans-serif;
    font-size: 8pt;
    color: #78716c;
  }
  @bottom-right {
    content: "Operator plane · 22 Aug 2026";
    font-family: "Avenir Next", "Segoe UI", Helvetica, sans-serif;
    font-size: 7.5pt;
    color: #a8a29e;
  }
...
<section class="cover">
  <div>
    ...
    <h1>Winter 2026/27<br>LINK-S and the list</h1>
    <p class="dek">A source-backed brief for Shen Ruililin on every winter row of the IAO Recognised Programmes list, plus LINK-S — scored for experience, meaning, and memory, without inventing a Lillehammer that January cannot buy.</p>
    <div class="banner">Enrol in LINK-S before 4 September 2026, 23:59, unless you have already chosen first-ness over family-and-credits. Tübingen and Lille are the NEWDAY cousins; their dates lose. Do not spend SSE on three weeks. Confirm HKUWW criterion 3 in writing.</div>
  </div>
  <div class="meta">
    ...
    <div>Research: IAO / LINK / Nansen / host pages · regional crawls</div>
  </div>
</section>
"""
...
def main() -> None:
    ...
    html_body += f"""
<h2>16. Claims register (volatile)</h2>
<p>Machine copy: <code>.tmp/winter-primer/claims.jsonl</code>. Re-check anything past <code>reverifyAfter</code> before you enrol. LINK Round 2 dies on 4 Sep 2026. Hanyang fees die on the 1 Sep site update.</p>
<table>
...
<head>
<meta charset="utf-8"/>
<title>Winter 2026/27 Primer</title>
<style>{CSS}</style>
</head>
<body>
{COVER}
