...
Path coherence (why GHD, Laidlaw heat–health, Gansu, WHS, Nordics, Global South, Laureate stewarding): [`docs/tung-ngai-why-this-path.md`](docs/tung-ngai-why-this-path.md). Tung & Ngai dream-fit: [`docs/tung-ngai-dream-fit-brief.md`](docs/tung-ngai-dream-fit-brief.md). Leadership / judgment wisdom corpus: [`docs/wisdom/`](docs/wisdom/README.md).
