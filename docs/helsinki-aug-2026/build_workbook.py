...
books = [
    ...
    ["6", "Latitude 25", "Wed 19 (closed Sun–Tue official)", "Call / site — no walk-ins",
     "https://www.latitude25.fi/booking/", "+358 9 6128 6000",
     "Shii €98 — hours VERIFY in DinnerBooking, not assumed Sun–Tue closed", "Only if Grön/Skörd fail and you want omakase"],
...
rests = [
    ...
    ["Shii", "Omakase / otsumami", "Kaartinkaupunki", "Fabianinkatu 17", "icon", "98e menu official", "Book DinnerBooking",
     "VERIFY", "VERIFY", "VERIFY", "VERIFY", "Leave 15:00",
     "11-course. Cannot be vegetarian. Do NOT copy Latitude's Sun–Tue closure onto Shii.", "Omakase; sake pairing 62e official",
     "https://shii.fi/menu", "Official menu/price; weekly hours not published — VERIFY in booker", 7],
    ["Hanayagi Omakase", "Aged sushi omakase", "Kaartinkaupunki", "Kasarmikatu 25", "icon", "150e course official booker", "Reservation only",
     "CLOSED*", "CLOSED*", "18:00–20:30*", "18:00–20:30*", "too late",
     "Eight seats. Tuesday sushi alternative if Nolla is full. Hours from TableOnline — VERIFY.", "Omakase",
     "https://www.tableonline.fi/en/helsinki/hanayagi-omakase/1689/book", "TableOnline hours; official concept page", 6],
    ["Domo", "Sushi à la carte", "Kamppi", "Kalevankatu 21", "neighbourhood", "VERIFY (2024 PDFs stale)", "Email / phone",
     "CLOSED", "11–14:30 & 17–21", "same", "same", "lunch if buffer",
     "À la carte, not buffet. July 2026 local coverage confirms it is active.", "Nigiri / bento",
     "http://www.domoravintola.fi/", "Official hours", 6],
    ["Restaurant Lia", "Modern Georgian", "Erottaja", "Erottajankatu 2 (enter Uudenmaankatu)", "hot", "VERIFY", "Book / call",
     "15–22", "CLOSED?*", "CLOSED", "16–22", "too late",
     "Georgian backup. Official pages conflict on Monday; contact page says open, venue page says Mon–Tue closed.", "Khachapuri / supra",
     "https://www.ravintolalia.fi/en-gb/helsinki", "Official pages conflict Mon — VERIFY", 6],
    ["Katana Ramen", "Ramen", "Punavuori / Telakka", "Telakkakatu 12", "hot", "VERIFY", "Walk-in",
     "CLOSED?*", "11–21*", "11–21*", "11–21*", "11–21*",
     "Dedicated ramen after Momotoko died. HS reviewed Jul 2026. Sunday omitted on Falstaff — not an official closure.", "Tonkotsu",
    ...
    ["Harju 8", "Bistro / natural wine", "Kallio", "Harjutori 8", "neighbourhood", "VERIFY lunch prices", "Walk-in — no reservation",
     "11–late; kitchen 11–22", "same; weekday lunch 11–15", "same", "same", "too late",
     "Spontaneous Kallio living room. Official: no reservations.", "Wine + plates; expect a wait",
     "https://harju8.fi/info/", "Official kitchen 11–22", 6],
    ...
    ["Finnjävel Salonki", "Finnish fine dining", "Töölönlahti", "Ainonkatu 3", "icon", "Salonki 108e / 138e official", "Book",
     "CLOSED", "CLOSED", "17–23", "17–23", "Leave 15:00",
     "Skip unless you decide to. Sali lunch exists Tue–Fri 11:30–15:00 — Thursday lunch collides with 15:00 out.", "Tasting",
     "https://finnjavel.fi/en/", "Official hours + menus", 3],
    ["Olo", "Nordic 1★", "Kruununhaka", "Pohjoisesplanadi 5", "icon", "Menu Olo 189e; Selected 109e official", "Book DinnerBooking",
     "CLOSED", "CLOSED", "18–24", "18–24", "too late",
     "Blow-budget alternative to Nolla on Tuesday. Polished harbour room, not the locked plan.", "Selected 109e if you must",
     "https://olo-ravintola.fi/en/menu-olo/", "Official hours + menu", 2],
    ["Palace", "Nordic 2★", "South Harbour", "Eteläranta 10, 10th floor", "icon", "250e inc water/coffee official", "Book DinnerBooking",
     "CLOSED", "CLOSED", "CLOSED", "dinner (clock VERIFY)", "too late",
     "Biggest splurge. Wednesday only in this window. Skip unless you choose the landmark room.", "Tasting; wine pairing 220e official",
     "https://palacerestaurant.fi/en/menu", "Official service days + menu", 2],
...
matrix = [
    ...
    ["Shii", "VERIFY", "VERIFY", "VERIFY", "VERIFY", "too late", "Official omits weekly hours"],
    ["Hanayagi", "CLOSED*", "CLOSED*", "OPEN 18–20:30*", "OPEN 18–20:30*", "too late", "TableOnline — VERIFY"],
    ["Domo", "CLOSED", "OPEN 11–14:30 & 17–21", "OPEN", "OPEN", "lunch if buffer", "Official"],
    ["Lia", "OPEN 15–22", "CLOSED?*", "CLOSED", "OPEN 16–22", "too late", "Official pages conflict on Monday"],
...
sources = [
    ...
    ["S-shii", "Shii menu 98e; hours omitted", "https://shii.fi/menu", ACCESSED, "High price; weekly hours VERIFY in booker"],
    ["S-hanayagi", "Hanayagi 150e + TableOnline hours", "https://hanayagi-omakase.com/about", ACCESSED, "High concept; hours from booker"],
    ["S-domo", "Domo hours", "http://www.domoravintola.fi/", ACCESSED, "High — official"],
    ["S-lia", "Lia hours (Mon conflict)", "https://www.ravintolalia.fi/en-gb/helsinki", ACCESSED, "High venue; Monday pages conflict"],
    ["S-olo", "Olo hours + 189e / 109e", "https://olo-ravintola.fi/en/info/", ACCESSED, "High — official"],
    ["S-palace", "Palace 250e menu", "https://palacerestaurant.fi/en/menu", ACCESSED, "High — official"],
