...
**Operator identity claim:** high-craft HK undergraduate; creates across professional, cultural, and institutional boundaries; embeds in the Mainland; international travel for comparison not escape; returns something usable to Hong Kong through a lifelong scholar community. Path coherence: [`docs/tung-ngai-why-this-path.md`](tung-ngai-why-this-path.md). Wisdom / leadership-in-transition corpus: [`docs/wisdom/`](wisdom/README.md).
